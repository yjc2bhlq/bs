<template>
	<div>
		<div class="container" :style='{"minHeight":"100vh","backgroundAttachment":"fixed","alignItems":"center","background":"url(http://codegen.caihongy.cn/20220722/eab26fea9eab42879fb16d218c70db52.png)","display":"flex","width":"100%","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"center"}'>
			<el-form v-if="pageFlag=='security1'" :style='{"padding":"40px 0 60px","boxShadow":"0 0px 0px rgba(64, 158, 255, .8)","margin":"0","borderRadius":"0","background":"rgba(255,255,255,0.8","width":"1000px","height":"auto"}' ref="rgsForm" class="rgs-form" :model="rgsForm">
				<div v-if="true" :style='{"margin":"0 0 30px 0","color":"#000","textAlign":"center","width":"100%","lineHeight":"44px","fontSize":"20px","fontWeight":"bold"}' class="title">基于Java的校园失物招领管理系统找回密码</div>
				<el-form-item :style='{"width":"50%","padding":"0","margin":"0 auto 10px","height":"auto"}' class="list-item">
				...
				<button :style='{"border":"0","cursor":"pointer","padding":"0 10px","boxShadow":"0 0 0px rgba(64, 158, 255, .5)","margin":"20px auto 5px","color":"#000","display":"block","outline":"none","borderRadius":"0","background":"#B6D8E9","width":"50%","fontSize":"20px","height":"170px"}' type="button" class="r-btn" @click="getSecurity()">下一步</button>
			...
			<el-form v-if="pageFlag=='security2'" :style='{"padding":"40px 0 60px","boxShadow":"0 0px 0px rgba(64, 158, 255, .8)","margin":"0","borderRadius":"0","background":"rgba(255,255,255,0.8","width":"1000px","height":"auto"}' ref="rgsForm" class="rgs-form" :model="rgsForm">
				<div v-if="true" :style='{"margin":"0 0 30px 0","color":"#000","textAlign":"center","width":"100%","lineHeight":"44px","fontSize":"20px","fontWeight":"bold"}' class="title">基于Java的校园失物招领管理系统密码重置</div>
				<el-form-item :style='{"width":"50%","padding":"0","margin":"0 auto 10px","height":"auto"}' class="list-item">
				...
				<button :style='{"border":"0","cursor":"pointer","padding":"0 10px","boxShadow":"0 0 0px rgba(64, 158, 255, .5)","margin":"20px auto 5px","color":"#000","display":"block","outline":"none","borderRadius":"0","background":"#B6D8E9","width":"50%","fontSize":"20px","height":"170px"}' type="button" class="r-btn" @click="validateSecurity()">下一步</button>
				<div :style='{"cursor":"pointer","padding":"0 10%","color":"rgba(159, 159, 159, 1)","textAlign":"center","display":"inline-block","width":"100%","lineHeight":"1","fontSize":"12px","textDecoration":"underline"}' class="r-login" @click="close()">已有账号，直接登录</div>
            </el-form>
			<el-form v-if="pageFlag=='security3'" :style='{"padding":"40px 0 60px","boxShadow":"0 0px 0px rgba(64, 158, 255, .8)","margin":"0","borderRadius":"0","background":"rgba(255,255,255,0.8","width":"1000px","height":"auto"}' ref="rgsForm" class="rgs-form" :model="rgsForm">
				<div v-if="true" :style='{"margin":"0 0 30px 0","color":"#000","textAlign":"center","width":"100%","lineHeight":"44px","fontSize":"20px","fontWeight":"bold"}' class="title">基于Java的校园失物招领管理系统密码重置</div>
				<el-form-item :style='{"width":"50%","padding":"0","margin":"0 auto 10px","height":"auto"}' class="list-item">
				...
				<button :style='{"border":"0","cursor":"pointer","padding":"0 10px","boxShadow":"0 0 0px rgba(64, 158, 255, .5)","margin":"20px auto 5px","color":"#000","display":"block","outline":"none","borderRadius":"0","background":"#B6D8E9","width":"50%","fontSize":"20px","height":"170px"}' type="button" class="r-btn" @click="updatePassword()">修改密码</button>
				<div :style='{"cursor":"pointer","padding":"0 10%","color":"rgba(159, 159, 159, 1)","textAlign":"center","display":"inline-block","width":"100%","lineHeight":"1","fontSize":"12px","textDecoration":"underline"}' class="r-login" @click="close()">已有账号，直接登录</div>
            </el-form>
			<el-form v-if="pageFlag=='register'" :style='{"padding":"40px 0 60px","boxShadow":"0 0px 0px rgba(64, 158, 255, .8)","margin":"0","borderRadius":"0","background":"rgba(255,255,255,0.8","width":"1000px","height":"auto"}' ref="rgsForm" class="rgs-form" :model="rgsForm">
				<div v-if="true" :style='{"margin":"0 0 30px 0","color":"#000","textAlign":"center","width":"100%","lineHeight":"44px","fontSize":"20px","fontWeight":"bold"}' class="title">基于Java的校园失物招领管理系统注册</div>

...
<div :style='{"padding":"20px 20px 40px","margin":"10px auto 0","borderColor":"#52b646","borderRadius":"12px","background":"#fff","borderWidth":"3px","width":"1200px","position":"relative","borderStyle":"solid dashed double double"}'>
    <el-form
      ...
      label-width="80px"
    >
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="认领编号" prop="renlingbianhao">
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="认领时间" prop="renlingshijian" >
              <el-date-picker
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="认领账号" prop="renlingzhanghao">
            <el-input v-model="ruleForm.renlingzhanghao" 
                placeholder="认领账号" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="认领姓名" prop="renlingxingming">
            <el-input v-model="ruleForm.renlingxingming" 
                placeholder="认领姓名" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="认领手机" prop="renlingshouji">
            <el-input v-model="ruleForm.renlingshouji" 
                placeholder="认领手机" clearable ></el-input>
          </el-form-item>
...
<script>
  export default {
    ...
    created() {
      ...
      this.ruleForm.renlingshijian = this.getCurDate()
    },
    methods: {
      getMakeZero(s) {
          return s < 10 ? '0' + s : s;
      ...
      init(type) {
        ...
        if(type=='cross'){
          ...
          for (var o in obj){
            ...
            if(o=='renlingxingming'){
              this.ruleForm.renlingxingming = obj[o];
              this.ro.renlingxingming = true;
              continue;
            }
            if(o=='renlingshouji'){
              this.ruleForm.renlingshouji = obj[o];
              this.ro.renlingshouji = true;
              continue;
            }
            if(o=='beizhu'){
        ...
        this.$http.get(this.userTableName + '/session', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
            ...
            if((json.yonghuzhanghao!=''&&json.yonghuzhanghao) || json.yonghuzhanghao==0){
                this.ruleForm.renlingzhanghao = json.yonghuzhanghao
            }
            if((json.yonghuxingming!=''&&json.yonghuxingming) || json.yonghuxingming==0){
                this.ruleForm.renlingxingming = json.yonghuxingming
            }
            if((json.lianxifangshi!=''&&json.lianxifangshi) || json.lianxifangshi==0){
                this.ruleForm.renlingshouji = json.lianxifangshi
            }
          }
        });
      },
    ...
    // 多级联动参数
      // 多级联动参数
      info(id) {
        this.$http.get('renlingxinxi/detail/${id}', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
        ...
        this.$refs["ruleForm"].validate(valid => {
          if(valid) {
            ...
            if(crossrefid && crossuserid) {
                 ...
                 this.$http.get('renlingxinxi/list', {
                  params: params
                 }).then(res => {
                     if(res.data.data.total>=crossoptnum) {
                         ...
                         // 跨表计算
                          ...
                          this.$http.post('renlingxinxi/add', this.ruleForm).then(res => {
                              if (res.data.code == 0) {
                                  this.$message({
                                      message: '操作成功',
                                      type: 'success',
